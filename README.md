...
**Free, open-source typing and vocabulary trainer for Chinese, Indonesian and English.**
...
![KetikLab — pinyin above the character, glosses in three languages](public/og.png)

## What is in it

Counts as of 2026-09-13; the library grows on a schedule (see *Content pipeline* below).

| | |
|---|---|
| Curated trilingual words | **3,701** — Chinese, Indonesian and English aligned by concept, with pinyin, IPA, Indonesian syllables and example sentences; categories: daily, business, life in Indonesia, study & policy |
| Exam libraries | **10 lists, nearly 18,000 words** (21,600+ across the site together with the curated collection) — English core / intermediate / advanced / academic (by Zipf frequency band) and a TOEFL list; Chinese core / intermediate / advanced; an Indonesian frequency list |
| Classic readings | **161** public-domain texts in the three languages, typed line by line |
...
**Who it is for:** Indonesians learning Chinese or English; Chinese speakers learning Indonesian; anyone who wants typing practice in these languages.
...
**免费、开源的中文 · 印尼语 · 英语三语打字与词汇训练站。** 一边打字，一边把词记住。

- **3,701** 个按概念对齐的三语精选词（附拼音、音标、印尼语音节、三语例句），分日常、商务、印尼生活、学习与政策四类
- **10 个考试词库，近 18,000 词**（连同三语精选，全站两万一千余词）：英语核心 / 进阶 / 高阶 / 学术（按 Zipf 词频分档）与托福词表；中文核心 / 进阶 / 高阶；印尼语高频词
...
适合：学中文或英语的印尼人、学印尼语的中文使用者，以及想练这三种语言打字的人。没有应用商店版本、没有 AI 老师、没有直播课、没有广告。
...
**Situs latihan mengetik dan kosakata yang gratis dan open source untuk bahasa Mandarin, Indonesia, dan Inggris.** Sambil mengetik, kata-katanya ikut hafal.

- **3.701** kata pilihan yang diselaraskan per konsep dalam tiga bahasa (pinyin, IPA, suku kata Indonesia, contoh kalimat); kategori harian, bisnis, hidup di Indonesia, belajar & kebijakan
- **10 kamus ujian, hampir 18.000 kata** (lebih dari 21.600 kata di seluruh situs): Inggris inti / lanjutan / tingkat atas / akademik (per pita frekuensi Zipf) dan daftar TOEFL; Mandarin inti / lanjutan / tingkat atas; daftar frekuensi bahasa Indonesia
...
Untuk: orang Indonesia yang belajar Mandarin atau Inggris, penutur Mandarin yang belajar bahasa Indonesia, dan siapa pun yang ingin latihan mengetik dalam tiga bahasa ini. Tidak ada aplikasi di toko aplikasi, tidak ada tutor AI, tidak ada kelas langsung, tidak ada iklan.
...
- 三语精选词：`public/data/words.json`（`Word` 对象数组）
...
### 内容规则
词汇须中 - 印 - 英语义对齐（非表面直译），优先日常 / 商务 / 印尼生活与公共服务 / 公共政策 / 学术研究。朗读只用公共领域或开放授权全文，逐条记录作者、年代、来源、授权。保持三语 UI，不混排。
